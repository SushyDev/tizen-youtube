...
const { MenuServiceItemRenderer } = await import('../../framework/ui/renderers.js');
const { longPressData } = await import('../../mods/longPressMenu/items.js');
const { SHELF, PIVOT, TILES, GRID, walkTiles, walkShelves } = await import('../../framework/registries/feed.js');

// Imported for its registrations: the visitor table under test is the one the shipped code installs.
// Each covers one of the oracle functions below — adblock (advert removal), dearrow, thumbnails
// (hq), longPressMenu, hideWatched, shorts, signinReminder.
await import('../../mods/feed/index.js');
await import('../../mods/adblock/index.js');
await import('../../mods/dearrow/index.js');
await import('../../mods/thumbnails/index.js');
await import('../../mods/longPressMenu/index.js');
await import('../../mods/hideWatched/index.js');
await import('../../mods/shorts/index.js');
await import('../../mods/signinReminder/index.js');

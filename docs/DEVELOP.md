...
| `npm run build` | The userscript, and the service twice: for Tizen 6.5+, and on node 4.4.3 for 5.0+ |
...
| `npm run package` | Build the unsigned `.wgt`s for Tizen Homebrew: `tube-tizen-6.5.wgt` and `tube-tizen-5.0.wgt` |

...
const { SHELF, walkTiles } = await import('../../framework/registries/feed.js');
const { bestOf } = await import('../../mods/dearrow/api.js');
await import('../../mods/dearrow/index.js');

// Exercised below: DeArrow disabled but hq thumbnails on, to check the two don't collide.
...
const suite = async () => {
    ...
    await checkAsync('what DeArrow said survives a restart', async () => {
        ...
        const reloaded = await import('../../mods/dearrow/store.js?relaunch=1');

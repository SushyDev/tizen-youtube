...
// Verifies the loader's guarantees: the bundled script always works, a cached
// update is only used when its digest matches, and a corrupted cache falls
// back rather than executing unverified code.

// `window._yttv` holds every class and singleton YouTube's bundle defines, under names a
// minifier chose that change every release. So everything is found by what it does, and

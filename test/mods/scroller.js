...
const { SPEEDS, start: startScrollSpeed } = await import('../../mods/scroller/speed.js');
const { SWITCHES, start: startSmoothNavigation } = await import('../../mods/scroller/smoothNavigation.js');
const { start: startRapidPress } = await import('../../mods/scroller/rapidPress.js');
